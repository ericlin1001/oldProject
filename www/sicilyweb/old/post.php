...
Notice: Undefined variable: finfo in /home/iladmin/sicily/web/temp.php(1) : eval()'d code on line 7
...
<div id="posts">
    ...
    <? while ($post->pull()): ?>
        ...
        <div class="post_box post_box_extend ui-corner-all">
            ...
            <div class="post_body post_content"><?= handleContent($post->content) ?></div>
            ...
            <? while ($replies->pull()): ?>
                ...
                <div class="reply_post_box">
                    ...
                    <div class="post_body post_content"><?= handleContent($replies->content) ?></div>
                </div>
            <? endwhile; ?>
