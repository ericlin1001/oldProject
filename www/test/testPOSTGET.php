...
$client = new HttpClient('uems.sysu.edu.cn');
/*	if($client->post('/action.php?act=Login',array(
    ...
    $cooies=array("JSESSIONID"=>"D67576102D4906AE4207923FF6C67AA6");
    print $cooies."<br>";
    $client->setCookies($cooies);
    $jes=$cooies['JSESSIONID'];
    echo "jes=".$jes."<br>";
    print $client->get('/jwxt/ria_http_export.do?method=download&expfname=xscj.xls&filepath=/opt/jwglxt/upload/1341458475453.xls');
