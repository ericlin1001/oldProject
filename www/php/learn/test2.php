...
echo "server:".$gethead['set-cookie'][0];
...
if(!$client->post("/action.php?act=Submit",array('pid'=>'1000','cid'=>'0','language'=>'2','source'=>'#include<iostream>
