...
<form name="getPid"  method="get" >
	...
	<label>num:<input name="num" type="input" id="num" value="1"></label>
	<input type="submit" value="Get" />   
</form>
<?php
if(isset($_GET[pid]) and $_GET[pid]!="" and isset($_GET[ch]) and $_GET[ch]!="" and isset($_GET[num]) and $_GET[num]!=""){
	...
	if($client->post('/action.php?act=Login',array(
		...
		for($i=0;$i<$num;$i++){
			...
			print "<textarea rows='7' cols='80%'>".htmlspecialchars($answer)."</textarea>";
			$pid++;
		}
	}
}else{
